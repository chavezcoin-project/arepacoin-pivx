...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ArepaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ArepaCoin Core"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ArepaCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("ArepaCoin Core"); // default title
