...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 47047;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // ArepaCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ArepaCoin: 1 day
        nTargetSpacing = 1 * 60;  // ArepaCoin: 1 minute
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "The most delicious coin has ever had the cryptocurrencies - 2017";
        ...
        genesis.nNonce = 1870413;

        // MineGenesis(genesis, bnProofOfWorkLimit);

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000036f645c1a6843832c5583fe2030d510f0574adb772eb0460eb207134625"));
        assert(genesis.hashMerkleRoot == uint256("0x8f043014070e7cc537f9ca3bbf039ab4fccc6fed8990d695b6900346016aff0b"));
...
public:
    CTestNetParams()
    {
        ...
        // Testnet arepacoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet arepacoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet arepacoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Arepacoin: 1 day
        nTargetSpacing = 1 * 60;        // Arepacoin: 1 minutes
