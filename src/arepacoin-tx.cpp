...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Arepacoin Core arepacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  arepacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded arepacoin transaction") + "\n" +
                               "  arepacoin-tx [options] -create [commands]   " + _("Create hex-encoded arepacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded arepacoin transaction
