...
In order to support loading of multiple wallets in arepacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is arepacoin.cpp.
...
Changes to arepacoin.cpp
----------------------
arepacoin.cpp is the entry point into arepacoin-qt, and as such, will require some minor modifications to provide hooks for
