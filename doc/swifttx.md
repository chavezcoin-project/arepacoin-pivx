...
This mechanism has been integrated into Bitcore-Node-ArepaCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ArepaCoin-Project/insight-api-arepacoin#web-socket-api](https://github.com/ArepaCoin-Project/insight-api-arepacoin#web-socket-api) 
* API: [https://github.com/ArepaCoin-Project/insight-api-arepacoin#swifttx-transactions](https://github.com/ArepaCoin-Project/insight-api-arepacoin#swifttx-transactions) 
...
By default, the ArepaCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ArepaCoin Core daemon:
