Contributing to ArepaCoin Core
============================

The ArepaCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ArepaCoin Core project, and is not to be
confused with overall ArepaCoin Network Protocol consensus changes.

Whether a pull request is merged into ArepaCoin Core rests with the project merge
...
Patches that change ArepaCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ArepaCoin consensus, it must have been
...
The project leader is the release manager for each ArepaCoin Core release.
